    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
	 {
        ...
        $sql = "UPDATE `employee` SET `eName`='$eName',`eAge`='$eAge',`eCategory`='$eCategory',`eAddress`='$eAddress',`ePhoneNo`='$ePhoneNo',`eBirthday`='$eBirthday',`eGender`='$eGender' WHERE ePhoneNo = '$ePhoneNo';";
...
<html>
<head>
	<title>Employee Modify | BANGABANDHU HEALTH CARE</title>
...
<body>
	<!-- ------------------------------------------------------------------------------------- -->
		...
		<div class="register">
			<h2>MODIFY EMPLOYEE DETAILS</h2><br>
			<form class="form" action="" method="post">
			  ...
			  <input class="formBox" type="text" id="phoneNo" name="phoneNo" placeholder=" Enter Previos Phone No."><br><br>
			  <!-- Birthday -->
