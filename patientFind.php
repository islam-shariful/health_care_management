    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
	 {
        ...
        $sql3 = "SELECT `billAmount` FROM `bill` WHERE `admitID` = '$pUserName' ;";
    ...
    <!-- ------------------------------------------------------------------------------------- -->
        ...
        <div class="register">
            ...
            <form class="form" action="" method="post">
              ...
              <input class="formBox search" type="text" id="userName" name="userName" placeholder=" Enter User Name" required autocomplete="off"><br><br>
             
              <!--live search res will be shown here-->
